...
let ouWidth = window
  .getComputedStyle(divOutput, null)
...
function loadHeaderButtons() {
  divHeader.innerHTML +=
    '<button onclick="enterStringOnWebpage()">Single String</button> ';
  divHeader.innerHTML +=
    '<button onclick="enterSentenceOnWebpage()">Sentence</button> ';
  divHeader.innerHTML +=
    '<button onclick="putStringValuesInArray()">Split Sentence</button> ';
  divHeader.innerHTML +=
    '<button onclick="putParagraphValuesInArrayAndSort()">Get word Count from paragraph</button> ';
  divHeader.innerHTML +=
    '<button onclick="arraySplice()">Splice Array</button> <br><br>';
  ...
  divHeader.innerHTML +=
    '<button onclick="arrayUnshift()">Unshift Array</button> ';
  divHeader.innerHTML +=
    '<button onclick="getFilteredArray()">Filter Array</button> <br></br>';
  divHeader.innerHTML +=
    '<button onclick="createBall()">Create A ball</button> ';
  divHeader.innerHTML +=
    '<button onclick="updateBalls()">Move that balls</button> ';
  divHeader.innerHTML +=
    '<button onclick="ballFactory()">Create more balls</button> ';
  let timTest;
  timtest = setTimeout(
    () =>
      (divHeader.innerHTML +=
        '<button onclick="timeout()">TIME OUT!</button> <button onclick="setDefault()">  Clear </button>'),
    5000
  );
}
...
function createBall() {
  ...
  setComment(
    "This function creates a ball in the output box on a fixed location."
  );
}
...
function ballFactory() {
  var nob = prompt(
    "Please enter a number between 0 and 100 to create this amount of balls.",
    "Enter a number!"
  );
  if (nob <= 100 && nob >= 0) {
    for (let i = 0; i < nob; i++) {
  ...
  setComment(
    "This function creates the amount of balls entered in the output box and will start updating locations."
  );
}
...
function arraySplice() {
  ...
  let someText =
    "This is the original array: <b>" +
    orig +
    "</b></BR></BR> This is the modified array, item 2 is removed and replaced by 2 other fruits: ";
  ...
  setComment(
    "This function is using the splice function to remove the item with index 1 (position 2 = Banana) and adds 2 new fruits"
  );
}
...
function arraySlice() {
  ...
  let someText =
    "This is the original array: <b>" +
    orig +
    "</b></BR></BR> This is the modified array, only part of the array is displayed ";

  let modif = arr.slice(1, 3);

  divOutput.innerHTML = someText + modif;
  setComment(
    "This function is using the slice function display a defined part of the array"
  );
}
function arrayPop() {
  let arr = createArray(1);
  ...
  let someText =
    "This is the original array: <b>" +
    orig +
    "</b></BR></BR> This is the modified array: ";
  ...
  divOutput.innerHTML = someText + modif;
  setComment(
    "This function is using the pop function to remove the last item in the array"
  );
}
...
function arrayPush() {
  ...
  divOutput.innerHTML = someText + modif;
  setComment(
    "This function is using the push function to add to the end of the array an item"
  );
}
function arrayShift() {
  let arr = createArray(1);
  ...
  divOutput.innerHTML = someText + modif;
  setComment(
    "This function is using the shift function to remove the first item from the array"
  );
}
function arrayUnshift() {
  ...
  divOutput.innerHTML = someText + modif;
  setComment(
    "This function is using the unshift function to add a new first item to the array"
  );
}
...
function getFilteredArray() {
  ...
  divOutput.innerHTML = someText + modif;
  setComment(
    "This function is using the filter function to filter out artists that made > 1M (dummy data) from a js datafile"
  );
}
...
function setDefault() {
  if (b === false)
    comment.innerHTML =
      "Select a button. The timer and clear button will appear after 5 seconds.";
...
function timeout() {
  clearOutput();
  tim = setInterval(function startTimer() {
    divOutput.innerHTML +=
      "<p> I will never stop running unless you press the clear button!</p>";
  }, 1000);
  setComment(
    "This function displays a sentence continuously every second until clear is pressed."
  );
}
...
function putStringValuesInArray() {
  ...
  let someText =
    "This is the original sentence: <b>" +
    orig +
    "</b></BR></BR> This is the modified sentence: ";
  let html = "";
  orig = orig.replace(".", "");
  ...
  setComment(
    "This function is splitting a sentence in a paragraph, removes the dot and places the items in the array in an unordered list."
  );
}
function putParagraphValuesInArrayAndSort() {
  ...
  barrVal.forEach(
    (item) => (html += "<li>" + item[0] + ":" + item[1] + "</li>")
  );
  divOutput.innerHTML = someText + "<ol>" + html + "</ol>";
  setComment(
    "This function is splitting a sentence in a paragraph, removes the dot and comma, counts the times the words are present, sorts the list with highest number descending, places the items in the array in an ordered list."
  );
}
